...
const Trabajadores_CursosController = require('./controllers/trabajadores_cursosController');
app.use(express.json());
app.get('/trabajadores_cursos', Trabajadores_CursosController.indexGet);
